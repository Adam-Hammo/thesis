...
n = (7.292115e-5)*time_svep;
Ceci2ecef = [cos(n),sin(n),0;-sin(n),cos(n),0;0,0,1]; 

[lat, long, ~] = ecef_to_llh_geocentric(GS_ECEF);

Clgcv2ecef = [-sin(lat)*cos(long),-sin(long),-cos(lat)*cos(long);

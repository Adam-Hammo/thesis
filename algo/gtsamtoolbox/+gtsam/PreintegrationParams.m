...
classdef PreintegrationParams < gtsam.PreintegratedRotationParams
  ...
  methods
    function obj = PreintegrationParams(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(4159, varargin{2});
        end
        base_ptr = gtsam_wrapper(4158, my_ptr);
      elseif nargin == 1 && isa(varargin{1},'double') && size(varargin{1},2)==1
        [ my_ptr, base_ptr ] = gtsam_wrapper(4160, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(4161, obj.ptr_gtsamPreintegrationParams);
    end
    ...
    function varargout = equals(this, varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'gtsam.PreintegrationParams') && isa(varargin{2},'double')
        varargout{1} = gtsam_wrapper(4162, this, varargin{:});
        return
      end
    ...
    function varargout = getAccelerometerCovariance(this, varargin)
      ...
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4163, this, varargin{:});
        return
      end
    ...
    function varargout = getIntegrationCovariance(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4164, this, varargin{:});
        return
      end
    ...
    function varargout = getUse2ndOrderCoriolis(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4165, this, varargin{:});
        return
      end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(4166, this, varargin{:});
        return
      end
      % PRINT usage: print() : returns void
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        gtsam_wrapper(4167, this, varargin{:});
        return
      end
    ...
    function varargout = string_serialize(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4168, this, varargin{:});
      else
    ...
    function varargout = setAccelerometerCovariance(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'double')
        gtsam_wrapper(4169, this, varargin{:});
        return
      end
    ...
    function varargout = setIntegrationCovariance(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 1 && isa(varargin{1},'double')
        gtsam_wrapper(4170, this, varargin{:});
        return
      end
    ...
    function varargout = setUse2ndOrderCoriolis(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'logical')
        gtsam_wrapper(4171, this, varargin{:});
        return
      end
  ...
  methods(Static = true)
    function varargout = MakeSharedD(varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 1 && isa(varargin{1},'double')
        varargout{1} = gtsam_wrapper(4172, varargin{:});
        return
      end
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4173, varargin{:});
        return
      end
    ...
    function varargout = MakeSharedU(varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 1 && isa(varargin{1},'double')
        varargout{1} = gtsam_wrapper(4174, varargin{:});
        return
      end
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4175, varargin{:});
        return
      end
    ...
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(4176, varargin{:});
      else

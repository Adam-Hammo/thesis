...
classdef SO4 < handle
  ...
  methods
    function obj = SO4(varargin)
      ...
      elseif nargin == 0
        my_ptr = gtsam_wrapper(892);
      elseif nargin == 1 && isa(varargin{1},'double')
        my_ptr = gtsam_wrapper(893, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(894, obj.ptr_gtsamSO4);
    end
  ...
  methods(Static = true)
    function varargout = Expmap(varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 1 && isa(varargin{1},'double') && size(varargin{1},2)==1
        varargout{1} = gtsam_wrapper(905, varargin{:});
        return
      end
    ...
    function varargout = FromMatrix(varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'double')
        varargout{1} = gtsam_wrapper(906, varargin{:});
        return
      end
    ...
    function varargout = Identity(varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(907, varargin{:});
        return
      end

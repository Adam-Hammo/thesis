  ...
  methods
    function obj = BearingRange2D(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(1701, my_ptr);
      elseif nargin == 2 && isa(varargin{1},'gtsam.Rot2') && isa(varargin{2},'double')
        my_ptr = gtsam_wrapper(1702, varargin{1}, varargin{2});
      else
    ...
    function delete(obj)
      gtsam_wrapper(1703, obj.ptr_gtsamBearingRange2D);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(1705, this, varargin{:});
        return
      end
  ...
  methods(Static = true)
    function varargout = Measure(varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'gtsam.Pose2') && isa(varargin{2},'double') && size(varargin{2},1)==2 && size(varargin{2},2)==1
        varargout{1} = gtsam_wrapper(1708, varargin{:});
        return
      end
    ...
    function varargout = MeasureBearing(varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 2 && isa(varargin{1},'gtsam.Pose2') && isa(varargin{2},'double') && size(varargin{2},1)==2 && size(varargin{2},2)==1
        varargout{1} = gtsam_wrapper(1709, varargin{:});
        return
      end
    ...
    function varargout = MeasureRange(varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 2 && isa(varargin{1},'gtsam.Pose2') && isa(varargin{2},'double') && size(varargin{2},1)==2 && size(varargin{2},2)==1
        varargout{1} = gtsam_wrapper(1710, varargin{:});
        return
      end

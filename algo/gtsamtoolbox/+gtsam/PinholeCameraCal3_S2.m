...
%PinholeCameraCal3_S2(PinholeCamera<gtsam::Cal3_S2> other)
...
classdef PinholeCameraCal3_S2 < handle
  ...
  methods
    function obj = PinholeCameraCal3_S2(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(1401, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(1402);
      elseif nargin == 1 && isa(varargin{1},'gtsam.PinholeCamera<gtsam::Cal3_S2>')
        my_ptr = gtsam_wrapper(1403, varargin{1});
      elseif nargin == 1 && isa(varargin{1},'gtsam.Pose3')
        my_ptr = gtsam_wrapper(1404, varargin{1});
      elseif nargin == 2 && isa(varargin{1},'gtsam.Pose3') && isa(varargin{2},'gtsam.Cal3_S2')
        my_ptr = gtsam_wrapper(1405, varargin{1}, varargin{2});
      else
    ...
    function delete(obj)
      gtsam_wrapper(1406, obj.ptr_gtsamPinholeCameraCal3_S2);
    end
    ...
    function varargout = projectSafe(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 1 && isa(varargin{1},'double') && size(varargin{1},1)==3 && size(varargin{1},2)==1
        [ varargout{1} varargout{2} ] = gtsam_wrapper(1418, this, varargin{:});
        return
      end
    ...
    function varargout = reprojectionError(this, varargin)
      ...
      error('Arguments do not match any overload of function gtsam.PinholeCameraCal3_S2.reprojectionError');
    end
    ...
    function varargout = string_serialize(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(1425, this, varargin{:});
      else
  ...
  methods(Static = true)
    function varargout = Dim(varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(1426, varargin{:});
        return
      end
    ...
    function varargout = Level(varargin)
      ...
      if length(varargin) == 3 && isa(varargin{1},'gtsam.Cal3_S2') && isa(varargin{2},'gtsam.Pose2') && isa(varargin{3},'double')
        varargout{1} = gtsam_wrapper(1427, varargin{:});
        return
      end
      ...
      if length(varargin) == 2 && isa(varargin{1},'gtsam.Pose2') && isa(varargin{2},'double')
        varargout{1} = gtsam_wrapper(1428, varargin{:});
        return
      end
    ...
    function varargout = Lookat(varargin)
      ...
      if length(varargin) == 4 && isa(varargin{1},'double') && size(varargin{1},1)==3 && size(varargin{1},2)==1 && isa(varargin{2},'double') && size(varargin{2},1)==3 && size(varargin{2},2)==1 && isa(varargin{3},'double') && size(varargin{3},1)==3 && size(varargin{3},2)==1 && isa(varargin{4},'gtsam.Cal3_S2')
        varargout{1} = gtsam_wrapper(1429, varargin{:});
        return
      end
    ...
    function varargout = Project(varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 1 && isa(varargin{1},'double') && size(varargin{1},1)==3 && size(varargin{1},2)==1
        varargout{1} = gtsam_wrapper(1430, varargin{:});
        return
      end
    ...
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(1431, varargin{:});
      else

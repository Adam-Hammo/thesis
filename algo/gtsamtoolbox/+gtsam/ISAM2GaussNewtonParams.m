  ...
  methods
    function obj = ISAM2GaussNewtonParams(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(2678, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(2679);
      else
    ...
    function delete(obj)
      gtsam_wrapper(2680, obj.ptr_gtsamISAM2GaussNewtonParams);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(2682, this, varargin{:});
        return
      end
      % PRINT usage: print() : returns void
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        gtsam_wrapper(2683, this, varargin{:});
        return
      end
    ...
    function varargout = setWildfireThreshold(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'double')
        gtsam_wrapper(2684, this, varargin{:});
        return
      end

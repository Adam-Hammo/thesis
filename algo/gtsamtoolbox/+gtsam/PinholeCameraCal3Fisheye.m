...
%PinholeCameraCal3Fisheye(PinholeCamera<gtsam::Cal3Fisheye> other)
...
classdef PinholeCameraCal3Fisheye < handle
  ...
  methods
    function obj = PinholeCameraCal3Fisheye(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(1525, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(1526);
      elseif nargin == 1 && isa(varargin{1},'gtsam.PinholeCamera<gtsam::Cal3Fisheye>')
        my_ptr = gtsam_wrapper(1527, varargin{1});
      elseif nargin == 1 && isa(varargin{1},'gtsam.Pose3')
        my_ptr = gtsam_wrapper(1528, varargin{1});
      elseif nargin == 2 && isa(varargin{1},'gtsam.Pose3') && isa(varargin{2},'gtsam.Cal3Fisheye')
        my_ptr = gtsam_wrapper(1529, varargin{1}, varargin{2});
      else
    ...
    function delete(obj)
      gtsam_wrapper(1530, obj.ptr_gtsamPinholeCameraCal3Fisheye);
    end
    ...
    function varargout = print(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        gtsam_wrapper(1539, this, varargin{:});
        return
      end
    ...
    function varargout = projectSafe(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 1 && isa(varargin{1},'double') && size(varargin{1},1)==3 && size(varargin{1},2)==1
        [ varargout{1} varargout{2} ] = gtsam_wrapper(1542, this, varargin{:});
        return
      end
    ...
    function varargout = reprojectionError(this, varargin)
      ...
      error('Arguments do not match any overload of function gtsam.PinholeCameraCal3Fisheye.reprojectionError');
    end
  ...
  methods(Static = true)
    function varargout = Dim(varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(1550, varargin{:});
        return
      end
    ...
    function varargout = Level(varargin)
      ...
      if length(varargin) == 3 && isa(varargin{1},'gtsam.Cal3Fisheye') && isa(varargin{2},'gtsam.Pose2') && isa(varargin{3},'double')
        varargout{1} = gtsam_wrapper(1551, varargin{:});
        return
      end
      ...
      if length(varargin) == 2 && isa(varargin{1},'gtsam.Pose2') && isa(varargin{2},'double')
        varargout{1} = gtsam_wrapper(1552, varargin{:});
        return
      end
    ...
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(1555, varargin{:});
      else

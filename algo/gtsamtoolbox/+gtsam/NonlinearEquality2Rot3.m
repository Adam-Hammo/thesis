...
classdef NonlinearEquality2Rot3 < gtsam.NoiseModelFactor
  ...
  methods
    function obj = NonlinearEquality2Rot3(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(3139, varargin{2});
        end
        base_ptr = gtsam_wrapper(3138, my_ptr);
      ...
      elseif nargin == 2 && isa(varargin{1},'gtsam.Key') && isa(varargin{2},'gtsam.Key')
        [ my_ptr, base_ptr ] = gtsam_wrapper(3141, varargin{1}, varargin{2});
      else
    ...
    function delete(obj)
      gtsam_wrapper(3142, obj.ptr_gtsamNonlinearEquality2Rot3);
    end

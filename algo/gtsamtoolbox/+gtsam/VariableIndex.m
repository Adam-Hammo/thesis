  ...
  methods
    function obj = VariableIndex(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(533, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(534);
      elseif nargin == 1 && isa(varargin{1},'gtsam.SymbolicFactorGraph')
        my_ptr = gtsam_wrapper(535, varargin{1});
      elseif nargin == 1 && isa(varargin{1},'gtsam.GaussianFactorGraph')
        my_ptr = gtsam_wrapper(536, varargin{1});
      ...
      elseif nargin == 1 && isa(varargin{1},'gtsam.VariableIndex')
        my_ptr = gtsam_wrapper(538, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(539, obj.ptr_gtsamVariableIndex);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'char') && isa(varargin{2},'gtsam.KeyFormatter')
        gtsam_wrapper(543, this, varargin{:});
        return
      end

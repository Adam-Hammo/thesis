  ...
  methods
    function obj = Point2Vector(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(798, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(799);
      elseif nargin == 1 && isa(varargin{1},'gtsam.Point2Vector')
        my_ptr = gtsam_wrapper(800, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(801, obj.ptr_gtsamPoint2Vector);
    end
    ...
    function varargout = pop_back(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        gtsam_wrapper(809, this, varargin{:});
        return
      end

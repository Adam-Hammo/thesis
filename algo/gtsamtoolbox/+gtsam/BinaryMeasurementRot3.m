  ...
  methods
    function obj = BinaryMeasurementRot3(varargin)
      ...
      elseif nargin == 4 && isa(varargin{1},'numeric') && isa(varargin{2},'numeric') && isa(varargin{3},'gtsam.Rot3') && isa(varargin{4},'gtsam.noiseModel.Base')
        my_ptr = gtsam_wrapper(4097, varargin{1}, varargin{2}, varargin{3}, varargin{4});
      else
    ...
    function delete(obj)
      gtsam_wrapper(4098, obj.ptr_gtsamBinaryMeasurementRot3);
    end
    ...
    function varargout = key1(this, varargin)
      ...
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4099, this, varargin{:});
        return
      end
    ...
    function varargout = key2(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4100, this, varargin{:});
        return
      end
    ...
    function varargout = measured(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4101, this, varargin{:});
        return
      end
    ...
    function varargout = noiseModel(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4102, this, varargin{:});
        return
      end

  ...
  methods
    function obj = SymbolicBayesTree(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(3346, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(3347);
      elseif nargin == 1 && isa(varargin{1},'gtsam.SymbolicBayesTree')
        my_ptr = gtsam_wrapper(3348, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(3349, obj.ptr_gtsamSymbolicBayesTree);
    end
    ...
    function varargout = deleteCachedShortcuts(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        gtsam_wrapper(3351, this, varargin{:});
        return
      end
    ...
    function varargout = numCachedSeparatorMarginals(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(3356, this, varargin{:});
        return
      end

...
classdef ConjugateGradientParameters < gtsam.IterativeOptimizationParameters
  ...
  methods
    function obj = ConjugateGradientParameters(varargin)
      ...
      elseif nargin == 0
        [ my_ptr, base_ptr ] = gtsam_wrapper(2221);
      else
    ...
    function delete(obj)
      gtsam_wrapper(2222, obj.ptr_gtsamConjugateGradientParameters);
    end
    ...
    function varargout = setEpsilon_rel(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 1 && isa(varargin{1},'double')
        gtsam_wrapper(2229, this, varargin{:});
        return
      end
    ...
    function varargout = setMaxIterations(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'numeric')
        gtsam_wrapper(2230, this, varargin{:});
        return
      end

  ...
  methods
    function obj = NavState(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(4129, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(4130);
      elseif nargin == 3 && isa(varargin{1},'gtsam.Rot3') && isa(varargin{2},'double') && size(varargin{2},1)==3 && size(varargin{2},2)==1 && isa(varargin{3},'double') && size(varargin{3},2)==1
        my_ptr = gtsam_wrapper(4131, varargin{1}, varargin{2}, varargin{3});
      elseif nargin == 2 && isa(varargin{1},'gtsam.Pose3') && isa(varargin{2},'double') && size(varargin{2},2)==1
        my_ptr = gtsam_wrapper(4132, varargin{1}, varargin{2});
      else
    ...
    function delete(obj)
      gtsam_wrapper(4133, obj.ptr_gtsamNavState);
    end
    ...
    function varargout = attitude(this, varargin)
      ...
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4134, this, varargin{:});
        return
      end
    ...
    function varargout = equals(this, varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'gtsam.NavState') && isa(varargin{2},'double')
        varargout{1} = gtsam_wrapper(4135, this, varargin{:});
        return
      end
    ...
    function varargout = localCoordinates(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.NavState')
        varargout{1} = gtsam_wrapper(4136, this, varargin{:});
        return
      end
    ...
    function varargout = pose(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4137, this, varargin{:});
        return
      end
    ...
    function varargout = position(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4138, this, varargin{:});
        return
      end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(4139, this, varargin{:});
        return
      end
      % PRINT usage: print() : returns void
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        gtsam_wrapper(4140, this, varargin{:});
        return
      end
    ...
    function varargout = retract(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'double') && size(varargin{1},2)==1
        varargout{1} = gtsam_wrapper(4141, this, varargin{:});
        return
      end
    ...
    function varargout = string_serialize(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4142, this, varargin{:});
      else
    ...
    function varargout = velocity(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4143, this, varargin{:});
        return
      end
  ...
  methods(Static = true)
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(4144, varargin{:});
      else

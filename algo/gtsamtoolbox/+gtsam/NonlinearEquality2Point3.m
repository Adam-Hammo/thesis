  ...
  methods
    function obj = NonlinearEquality2Point3(varargin)
      ...
      elseif nargin == 3 && isa(varargin{1},'gtsam.Key') && isa(varargin{2},'gtsam.Key') && isa(varargin{3},'double')
        [ my_ptr, base_ptr ] = gtsam_wrapper(3110, varargin{1}, varargin{2}, varargin{3});
      elseif nargin == 2 && isa(varargin{1},'gtsam.Key') && isa(varargin{2},'gtsam.Key')
        [ my_ptr, base_ptr ] = gtsam_wrapper(3111, varargin{1}, varargin{2});
      else
    ...
    function delete(obj)
      gtsam_wrapper(3112, obj.ptr_gtsamNonlinearEquality2Point3);
    end

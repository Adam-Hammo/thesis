  ...
  methods
    function obj = KeyPairDoubleMap(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(4065, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(4066);
      elseif nargin == 1 && isa(varargin{1},'gtsam.KeyPairDoubleMap')
        my_ptr = gtsam_wrapper(4067, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(4068, obj.ptr_gtsamKeyPairDoubleMap);
    end
    ...
    function varargout = at(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'pairsize_tsize_t')
        varargout{1} = gtsam_wrapper(4069, this, varargin{:});
        return
      end
    ...
    function varargout = clear(this, varargin)
      ...
      if length(varargin) == 0
        gtsam_wrapper(4070, this, varargin{:});
        return
      end
    ...
    function varargout = empty(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4071, this, varargin{:});
        return
      end
    ...
    function varargout = size(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4072, this, varargin{:});
        return
      end

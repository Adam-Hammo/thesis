...
classdef Diagonal < gtsam.noiseModel.Gaussian
  ...
  methods
    function obj = Diagonal(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(1803, varargin{2});
        end
        base_ptr = gtsam_wrapper(1802, my_ptr);
      else
    ...
    function delete(obj)
      gtsam_wrapper(1804, obj.ptr_gtsamnoiseModelDiagonal);
    end
  ...
  methods(Static = true)
    function varargout = Precisions(varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'double') && size(varargin{1},2)==1 && isa(varargin{2},'logical')
        varargout{1} = gtsam_wrapper(1809, varargin{:});
        return
      end
      ...
      if length(varargin) == 1 && isa(varargin{1},'double') && size(varargin{1},2)==1
        varargout{1} = gtsam_wrapper(1810, varargin{:});
        return
      end
    ...
    function varargout = Sigmas(varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 2 && isa(varargin{1},'double') && size(varargin{1},2)==1 && isa(varargin{2},'logical')
        varargout{1} = gtsam_wrapper(1811, varargin{:});
        return
      end
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 1 && isa(varargin{1},'double') && size(varargin{1},2)==1
        varargout{1} = gtsam_wrapper(1812, varargin{:});
        return
      end
    ...
    function varargout = Variances(varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 2 && isa(varargin{1},'double') && size(varargin{1},2)==1 && isa(varargin{2},'logical')
        varargout{1} = gtsam_wrapper(1813, varargin{:});
        return
      end
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 1 && isa(varargin{1},'double') && size(varargin{1},2)==1
        varargout{1} = gtsam_wrapper(1814, varargin{:});
        return
      end

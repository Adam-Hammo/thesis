  ...
  methods
    function obj = SO3(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(872, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(873);
      elseif nargin == 1 && isa(varargin{1},'double')
        my_ptr = gtsam_wrapper(874, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(875, obj.ptr_gtsamSO3);
    end
  ...
  methods(Static = true)
    function varargout = AxisAngle(varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'double') && size(varargin{1},2)==1 && isa(varargin{2},'double')
        varargout{1} = gtsam_wrapper(886, varargin{:});
        return
      end
    ...
    function varargout = ClosestTo(varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'double')
        varargout{1} = gtsam_wrapper(887, varargin{:});
        return
      end
    ...
    function varargout = Expmap(varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 1 && isa(varargin{1},'double') && size(varargin{1},2)==1
        varargout{1} = gtsam_wrapper(888, varargin{:});
        return
      end
    ...
    function varargout = FromMatrix(varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 1 && isa(varargin{1},'double')
        varargout{1} = gtsam_wrapper(889, varargin{:});
        return
      end

...
classdef PreintegratedAhrsMeasurements < handle
  ...
  methods
    ...
    function delete(obj)
      gtsam_wrapper(4248, obj.ptr_gtsamPreintegratedAhrsMeasurements);
    end
    ...
    function varargout = biasHat(this, varargin)
      ...
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4249, this, varargin{:});
        return
      end
    ...
    function varargout = deltaRij(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4250, this, varargin{:});
        return
      end
    ...
    function varargout = deltaTij(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4251, this, varargin{:});
        return
      end
    ...
    function varargout = equals(this, varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'gtsam.PreintegratedAhrsMeasurements') && isa(varargin{2},'double')
        varargout{1} = gtsam_wrapper(4252, this, varargin{:});
        return
      end
    ...
    function varargout = integrateMeasurement(this, varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'double') && size(varargin{1},2)==1 && isa(varargin{2},'double')
        gtsam_wrapper(4253, this, varargin{:});
        return
      end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(4254, this, varargin{:});
        return
      end
      % PRINT usage: print() : returns void
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        gtsam_wrapper(4255, this, varargin{:});
        return
      end
    ...
    function varargout = resetIntegration(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        gtsam_wrapper(4256, this, varargin{:});
        return
      end

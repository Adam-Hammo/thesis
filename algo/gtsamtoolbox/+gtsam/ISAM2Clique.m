  ...
  methods
    function obj = ISAM2Clique(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(2721, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(2722);
      else
    ...
    function delete(obj)
      gtsam_wrapper(2723, obj.ptr_gtsamISAM2Clique);
    end
    ...
    function varargout = gradientContribution(this, varargin)
      ...
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(2724, this, varargin{:});
        return
      end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 2 && isa(varargin{1},'char') && isa(varargin{2},'gtsam.KeyFormatter')
        gtsam_wrapper(2725, this, varargin{:});
        return
      end
      % PRINT usage: print(string s) : returns void
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(2726, this, varargin{:});
        return
      end
      % PRINT usage: print() : returns void
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        gtsam_wrapper(2727, this, varargin{:});
        return
      end

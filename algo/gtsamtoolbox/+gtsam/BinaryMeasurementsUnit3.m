  ...
  methods
    function obj = BinaryMeasurementsUnit3(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(3950, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(3951);
      else
    ...
    function delete(obj)
      gtsam_wrapper(3952, obj.ptr_gtsamBinaryMeasurementsUnit3);
    end
    ...
    function varargout = at(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'numeric')
        varargout{1} = gtsam_wrapper(3953, this, varargin{:});
        return
      end
    ...
    function varargout = push_back(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.BinaryMeasurementUnit3')
        gtsam_wrapper(3954, this, varargin{:});
        return
      end
    ...
    function varargout = size(this, varargin)
      ...
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(3955, this, varargin{:});
        return
      end

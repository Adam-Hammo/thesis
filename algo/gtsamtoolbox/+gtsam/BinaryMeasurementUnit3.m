  ...
  methods
    function obj = BinaryMeasurementUnit3(varargin)
      ...
      elseif nargin == 4 && isa(varargin{1},'numeric') && isa(varargin{2},'numeric') && isa(varargin{3},'gtsam.Unit3') && isa(varargin{4},'gtsam.noiseModel.Base')
        my_ptr = gtsam_wrapper(4090, varargin{1}, varargin{2}, varargin{3}, varargin{4});
      else
    ...
    function delete(obj)
      gtsam_wrapper(4091, obj.ptr_gtsamBinaryMeasurementUnit3);
    end
    ...
    function varargout = key1(this, varargin)
      ...
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4092, this, varargin{:});
        return
      end
    ...
    function varargout = key2(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4093, this, varargin{:});
        return
      end
    ...
    function varargout = measured(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4094, this, varargin{:});
        return
      end
    ...
    function varargout = noiseModel(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4095, this, varargin{:});
        return
      end

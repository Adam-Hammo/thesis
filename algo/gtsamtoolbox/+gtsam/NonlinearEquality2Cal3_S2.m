...
classdef NonlinearEquality2Cal3_S2 < gtsam.NoiseModelFactor
  ...
  methods
    function obj = NonlinearEquality2Cal3_S2(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(3157, varargin{2});
        end
        base_ptr = gtsam_wrapper(3156, my_ptr);
      ...
      elseif nargin == 2 && isa(varargin{1},'gtsam.Key') && isa(varargin{2},'gtsam.Key')
        [ my_ptr, base_ptr ] = gtsam_wrapper(3159, varargin{1}, varargin{2});
      else
    ...
    function delete(obj)
      gtsam_wrapper(3160, obj.ptr_gtsamNonlinearEquality2Cal3_S2);
    end

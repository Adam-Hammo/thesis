...
%getNewFactorsIndices() : returns gtsam::FactorIndices
  ...
  methods
    function obj = ISAM2Result(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(2728, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(2729);
      else
    ...
    function delete(obj)
      gtsam_wrapper(2730, obj.ptr_gtsamISAM2Result);
    end
    ...
    function varargout = getNewFactorsIndices(this, varargin)
      % GETNEWFACTORSINDICES usage: getNewFactorsIndices() : returns gtsam.FactorIndices
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(2734, this, varargin{:});
        return
      end
      error('Arguments do not match any overload of function gtsam.ISAM2Result.getNewFactorsIndices');
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(2737, this, varargin{:});
        return
      end

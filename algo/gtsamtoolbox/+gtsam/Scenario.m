...
classdef Scenario < handle
  ...
  methods
    function obj = Scenario(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(4308, varargin{2});
        end
        gtsam_wrapper(4307, my_ptr);
      else
    ...
    function delete(obj)
      gtsam_wrapper(4309, obj.ptr_gtsamScenario);
    end
    ...
    function varargout = acceleration_b(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'double')
        varargout{1} = gtsam_wrapper(4310, this, varargin{:});
        return
      end
    ...
    function varargout = acceleration_n(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 1 && isa(varargin{1},'double')
        varargout{1} = gtsam_wrapper(4311, this, varargin{:});
        return
      end
    ...
    function varargout = navState(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 1 && isa(varargin{1},'double')
        varargout{1} = gtsam_wrapper(4312, this, varargin{:});
        return
      end
    ...
    function varargout = omega_b(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 1 && isa(varargin{1},'double')
        varargout{1} = gtsam_wrapper(4313, this, varargin{:});
        return
      end
    ...
    function varargout = pose(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 1 && isa(varargin{1},'double')
        varargout{1} = gtsam_wrapper(4314, this, varargin{:});
        return
      end
    ...
    function varargout = rotation(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 1 && isa(varargin{1},'double')
        varargout{1} = gtsam_wrapper(4315, this, varargin{:});
        return
      end
    ...
    function varargout = velocity_b(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 1 && isa(varargin{1},'double')
        varargout{1} = gtsam_wrapper(4316, this, varargin{:});
        return
      end
    ...
    function varargout = velocity_n(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 1 && isa(varargin{1},'double')
        varargout{1} = gtsam_wrapper(4317, this, varargin{:});
        return
      end

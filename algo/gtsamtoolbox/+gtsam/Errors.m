  ...
  methods
    function obj = Errors(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(2201, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(2202);
      elseif nargin == 1 && isa(varargin{1},'gtsam.VectorValues')
        my_ptr = gtsam_wrapper(2203, varargin{1});
      else
    ...
    function delete(obj)
      gtsam_wrapper(2204, obj.ptr_gtsamErrors);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'char')
        gtsam_wrapper(2206, this, varargin{:});
        return
      end
      % PRINT usage: print() : returns void
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        gtsam_wrapper(2207, this, varargin{:});
        return
      end

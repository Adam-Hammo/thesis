  ...
  methods
    function obj = BetweenFactorPose3s(varargin)
      if nargin == 2 && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        my_ptr = varargin{2};
        gtsam_wrapper(3675, my_ptr);
      elseif nargin == 0
        my_ptr = gtsam_wrapper(3676);
      else
    ...
    function delete(obj)
      gtsam_wrapper(3677, obj.ptr_gtsamBetweenFactorPose3s);
    end
    ...
    function varargout = at(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'numeric')
        varargout{1} = gtsam_wrapper(3678, this, varargin{:});
        return
      end
    ...
    function varargout = push_back(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.BetweenFactorPose3')
        gtsam_wrapper(3679, this, varargin{:});
        return
      end
    ...
    function varargout = size(this, varargin)
      ...
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(3680, this, varargin{:});
        return
      end

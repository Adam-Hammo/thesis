...
classdef MFAS < handle
  ...
  methods
    ...
    function delete(obj)
      gtsam_wrapper(4075, obj.ptr_gtsamMFAS);
    end
    ...
    function varargout = computeOrdering(this, varargin)
      ...
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4076, this, varargin{:});
        return
      end
    ...
    function varargout = computeOutlierWeights(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(4077, this, varargin{:});
        return
      end

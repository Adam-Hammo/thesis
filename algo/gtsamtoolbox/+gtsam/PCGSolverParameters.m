...
classdef PCGSolverParameters < gtsam.ConjugateGradientParameters
  ...
  methods
    function obj = PCGSolverParameters(varargin)
      if (nargin == 2 || (nargin == 3 && strcmp(varargin{3}, 'void'))) && isa(varargin{1}, 'uint64') && varargin{1} == uint64(5139824614673773682)
        if nargin == 2
          ...
          my_ptr = gtsam_wrapper(2246, varargin{2});
        end
        base_ptr = gtsam_wrapper(2245, my_ptr);
      elseif nargin == 0
        [ my_ptr, base_ptr ] = gtsam_wrapper(2247);
      else
    ...
    function delete(obj)
      gtsam_wrapper(2248, obj.ptr_gtsamPCGSolverParameters);
    end
    ...
    function varargout = print(this, varargin)
      ...
      if length(varargin) == 0
        gtsam_wrapper(2250, this, varargin{:});
        return
      end
    ...
    function varargout = setPreconditionerParams(this, varargin)
      ...
      if length(varargin) == 1 && isa(varargin{1},'gtsam.PreconditionerParameters')
        gtsam_wrapper(2251, this, varargin{:});
        return
      end

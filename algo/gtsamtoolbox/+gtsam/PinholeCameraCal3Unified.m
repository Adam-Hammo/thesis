...
%PinholeCameraCal3Unified(PinholeCamera<gtsam::Cal3Unified> other)
...
classdef PinholeCameraCal3Unified < handle
  ...
  methods
    function obj = PinholeCameraCal3Unified(varargin)
      ...
      elseif nargin == 1 && isa(varargin{1},'gtsam.PinholeCamera<gtsam::Cal3Unified>')
    ...
    function delete(obj)
      gtsam_wrapper(1468, obj.ptr_gtsamPinholeCameraCal3Unified);
    end
    ...
    function varargout = print(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        gtsam_wrapper(1477, this, varargin{:});
        return
      end
    ...
    function varargout = projectSafe(this, varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 1 && isa(varargin{1},'double') && size(varargin{1},1)==3 && size(varargin{1},2)==1
        [ varargout{1} varargout{2} ] = gtsam_wrapper(1480, this, varargin{:});
        return
      end
    ...
    function varargout = reprojectionError(this, varargin)
      ...
      error('Arguments do not match any overload of function gtsam.PinholeCameraCal3Unified.reprojectionError');
    end
  ...
  methods(Static = true)
    function varargout = Dim(varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 0
        varargout{1} = gtsam_wrapper(1488, varargin{:});
        return
      end
    ...
    function varargout = Level(varargin)
      ...
      if length(varargin) == 3 && isa(varargin{1},'gtsam.Cal3Unified') && isa(varargin{2},'gtsam.Pose2') && isa(varargin{3},'double')
        varargout{1} = gtsam_wrapper(1489, varargin{:});
        return
      end
      ...
      if length(varargin) == 2 && isa(varargin{1},'gtsam.Pose2') && isa(varargin{2},'double')
        varargout{1} = gtsam_wrapper(1490, varargin{:});
        return
      end
    ...
    function varargout = Lookat(varargin)
      ...
      if length(varargin) == 4 && isa(varargin{1},'double') && size(varargin{1},1)==3 && size(varargin{1},2)==1 && isa(varargin{2},'double') && size(varargin{2},1)==3 && size(varargin{2},2)==1 && isa(varargin{3},'double') && size(varargin{3},1)==3 && size(varargin{3},2)==1 && isa(varargin{4},'gtsam.Cal3Unified')
        varargout{1} = gtsam_wrapper(1491, varargin{:});
        return
      end
    ...
    function varargout = Project(varargin)
      ...
      % Doxygen can be found at https://gtsam.org/doxygen/
      if length(varargin) == 1 && isa(varargin{1},'double') && size(varargin{1},1)==3 && size(varargin{1},2)==1
        varargout{1} = gtsam_wrapper(1492, varargin{:});
        return
      end
    ...
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(1493, varargin{:});
      else

...
classdef DoglegOptimizer < gtsam.NonlinearOptimizer
  ...
  methods
    ...
    function delete(obj)
      gtsam_wrapper(2668, obj.ptr_gtsamDoglegOptimizer);
    end

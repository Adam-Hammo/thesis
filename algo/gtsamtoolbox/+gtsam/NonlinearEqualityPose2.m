  ...
  methods
    function obj = NonlinearEqualityPose2(varargin)
      ...
      elseif nargin == 2 && isa(varargin{1},'numeric') && isa(varargin{2},'gtsam.Pose2')
        [ my_ptr, base_ptr ] = gtsam_wrapper(3035, varargin{1}, varargin{2});
      elseif nargin == 3 && isa(varargin{1},'numeric') && isa(varargin{2},'gtsam.Pose2') && isa(varargin{3},'double')
        [ my_ptr, base_ptr ] = gtsam_wrapper(3036, varargin{1}, varargin{2}, varargin{3});
      else
    ...
    function delete(obj)
      gtsam_wrapper(3037, obj.ptr_gtsamNonlinearEqualityPose2);
    end
  ...
  methods(Static = true)
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(3039, varargin{:});
      else
